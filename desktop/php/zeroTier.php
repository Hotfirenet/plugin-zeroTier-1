...
<div class="row row-overflow">
	...
	<div class="col-xs-12 eqLogicThumbnailDisplay">
		<div class="row">
			<div class="col-sm-10">
				...
				<div class="eqLogicThumbnailContainer">
					...
					<div class="cursor eqLogicAction logoSecondary" id="installZeroTier">
						<i class="fas fa-wrench"></i>
						<br>
						<span>{{Installer ZeroTier}}</span>
					</div>
					<div class="cursor eqLogicAction logoSecondary" id="getNetworkList">
					<i class='icon fas fa-download'></i>
						<br>
						<span>{{Recuperer Networks}}</span>
					</div> 
					<div class="cursor eqLogicAction logoPrimary" id="networkModal">
					  <i class="fas fa-plus-circle"></i>
						<br>
						<span>{{Nouveau Network}}</span>
					</div> 
					<div class="cursor eqLogicAction logoPrimary" id="handleUsers">
					  <i class='icon fas fa-users'></i>
						<br>
						<span>{{Gerer Utilisateurs}}</span>
					</div>  
					<div class="cursor eqLogicAction logoPrimary" id="handleNetworks">
					<i class='icon fas fa-network-wired'></i>
						<br>
						<span>{{Gérer Réseaux}}</span>
					</div>  
				</div>
			</div>
			<?php
		...
		<legend><i class="fas fa-table"></i> {{Mes Reseaux}}</legend>
		<?php
		if (count($eqLogics) == 0) {
